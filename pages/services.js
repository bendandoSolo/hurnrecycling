...
const services = () => {
  return (
    <>
       ...
       <meta name="description" content="General Waste Collection, Dry Mixed Recycling, Cardboard and Paper, Glass, Food, Polystyrene, WEEE Recycling in Bournemouth, Poole, Dorset and the South West." /> 
